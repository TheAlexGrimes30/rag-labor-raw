---
id: foreign_citizens_rf_article_25
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_24_1
    next: foreign_citizens_rf_article_26
...
# Статья 25 Федерального закона № 115-ФЗ
## Утратила силу

Статья 25 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
