---
id: foreign_citizens_rf_article_28_1
...
tree_rag:
  hierarchy:
    level: article
    parent: foreign_citizens_rf_chapter_4

  navigation:
    prev: foreign_citizens_rf_article_28
    next: foreign_citizens_rf_article_29
...
# Статья 28.1 Федерального закона № 115-ФЗ
## Утратила силу

Статья 28.1 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
