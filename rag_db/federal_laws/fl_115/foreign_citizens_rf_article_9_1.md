---
id: foreign_citizens_rf_article_9_1
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_9
    next: foreign_citizens_rf_article_10
...
# Статья 9.1 Федерального закона № 115-ФЗ
## Режим высылки

Статья регулирует вопросы по теме «Режим высылки» и устанавливает соответствующие права, обязанности, ограничения, процедуры или полномочия участников миграционных правоотношений.
...
1. Статья регулирует вопрос: **режим высылки**.
