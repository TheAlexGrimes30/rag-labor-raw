---
id: foreign_citizens_rf_article_22
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_21
    next: foreign_citizens_rf_article_23
...
# Статья 22 Федерального закона № 115-ФЗ
## Утратила силу

Статья 22 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
