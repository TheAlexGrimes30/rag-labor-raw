---
id: foreign_citizens_rf_article_21
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_20
    next: foreign_citizens_rf_article_22
...
# Статья 21 Федерального закона № 115-ФЗ
## Утратила силу

Статья 21 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
