---
id: foreign_citizens_rf_article_20
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_19
    next: foreign_citizens_rf_article_21
...
# Статья 20 Федерального закона № 115-ФЗ
## Утратила силу

Статья 20 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
