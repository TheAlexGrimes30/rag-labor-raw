---
id: foreign_citizens_rf_article_23
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_22
    next: foreign_citizens_rf_article_24
...
# Статья 23 Федерального закона № 115-ФЗ
## Утратила силу

Статья 23 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
