---
id: foreign_citizens_rf_article_26
...
tree_rag:
  ...
  navigation:
    prev: foreign_citizens_rf_article_25
    next: foreign_citizens_rf_article_27
...
# Статья 26 Федерального закона № 115-ФЗ
## Утратила силу

Статья 26 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
