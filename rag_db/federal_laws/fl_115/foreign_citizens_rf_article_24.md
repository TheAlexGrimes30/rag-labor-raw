---
id: foreign_citizens_rf_article_24
...
tree_rag:
  hierarchy:
    level: article
    parent: foreign_citizens_rf_chapter_3

  navigation:
    prev: foreign_citizens_rf_article_23
    next: foreign_citizens_rf_article_24_1
...
# Статья 24 Федерального закона № 115-ФЗ
## Утратила силу

Статья 24 утратила силу. Файл сохранен в корпусе для сохранения полной структуры закона, исторической навигации и корректных связей между соседними статьями.
